...
# Machine learning models for imipenem resistance prediction
# ===========================================================
...
saveRDS(rf_model, file.path(ml_models_dir, "random_forest_imipenem.rds"))
saveRDS(rf_metrics, file.path(ml_models_dir, "random_forest_imipenem_metrics.rds"))
saveRDS(rf_predictions, file.path(ml_models_dir, "random_forest_imipenem_predictions.rds"))
saveRDS(rf_roc, file.path(ml_models_dir, "random_forest_imipenem_roc.rds"))

## XGBoost

saveRDS(xgb_model, file.path(ml_models_dir, "xgboost_imipenem.rds"))
saveRDS(xgb_metrics, file.path(ml_models_dir,"xgboost_imipenem_metrics.rds"))
saveRDS(xgb_predictions, file.path(ml_models_dir, "xgboost_imipenem_predictions.rds"))
saveRDS(xgb_roc, file.path(ml_models_dir, "xgboost_imipenem_roc.rds"))

cat("\n=====================================\n")
cat("Imipenem machine learning completed\n")
cat("=====================================\n")
cat("\nResults saved in:\n")
cat(ml_models_dir, "\n")
